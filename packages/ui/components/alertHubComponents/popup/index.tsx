  ...
  const IOSSwitch = styled((props: any) => (
    ...
    '& .MuiSwitch-switchBase': {
      ...
      '&.Mui-checked': {
        ...
        color: '#fff',
        '& + .MuiSwitch-track': {
          backgroundColor: theme.palette.mode === 'dark' ? '#2ECA45' : '#464775',
          opacity: 1,
          border: 0,
        },
      ...
      <Grid container>
        <Grid item xs={12}>
              ...
              <FormControlLabel
                control={
                  <IOSSwitch
                    ...
                    onChange={(value: any) => props?.updateState('isActive', value.target.checked)}
                  />
                }
                label="is Active"
              />
              <FormControlLabel
                control={
                  <IOSSwitch
                    ...
                    onChange={(value: any) => props?.updateState('is_push', value.target.checked)}
                  />
                }
                label="Push"
              />
              <FormControlLabel
                control={
                  <IOSSwitch
                    ...
                    onChange={(value: any) => props?.updateState('is_email', value.target.checked)}
                  />
                }
                label="E-mail"
              />
              <FormControlLabel
                control={
                  <IOSSwitch
                    ...
                    onChange={(value: any) => props?.updateState('is_sms', value.target.checked)}
                  />
                }
                label="SMS"
              />
          ...
          <Box>
            ...
            <Stack direction="row" justifyContent="end" mb={2} sx={popup_style.btns}>
              <Typography onClick={props?.handleClose} sx={popup_style.btnone}>
                Cancel
              </Typography>
