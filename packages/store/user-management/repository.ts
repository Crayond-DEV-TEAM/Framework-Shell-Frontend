...
export const useRepository = create<UserManagementInterface>((set, get) => ({
  ...
  getAllRepository: () => {
    ...
    httpRequest('get', `${envConfig.api_idm_url}/repository`, {}, true)
      .then((response) => {
  ...
  createRepository: () => {
    ...
    httpRequest('post', `${envConfig.api_idm_url}/repository/upsert`, { data: { editRepositoryList } }, true)
      .then((response) => {
  ...
  editRepository: () => {
    ...
    httpRequest('post', `${envConfig.api_idm_url}/repository/upsert`, payload, true)
      .then((response) => {
        enqueueSnackbar('Json Updated Succesfully!', { variant: 'success' });
      })
      .catch((err) => {
