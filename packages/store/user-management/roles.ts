...
export const useRoles = create<RolesInterface>((set, get) => ({
  ...
  getRolesList: () => {
    ...
    httpRequest('post', `${envConfig.api_url}/idm/roles/get`, payload, true, apiToken , '3ef02e4b-b862-47b0-a48c-939b2e9d16d9')
      .then((response) => {
  ...
  addRolesList: async () => {
    ...
    return new Promise((resolve, reject) => {
      httpRequest('post', `${envConfig.api_url}/idm/roles/create`, payload, true, apiToken , '3ef02e4b-b862-47b0-a48c-939b2e9d16d9')
        .then((response) => {
  ...
  getStatusList: async (id: any, status: any) => {
    ...
    httpRequest('put', `${envConfig.api_url}/idm/roles/update`, payload, true, apiToken ,'3ef02e4b-b862-47b0-a48c-939b2e9d16d9')
      .then((response) => {
  ...
  editRoleList: async () => {
    ...
    return new Promise((resolve, reject) => {
      return httpRequest('put', `${envConfig.api_url}/idm/roles/update`, payload, true, apiToken ,'3ef02e4b-b862-47b0-a48c-939b2e9d16d9')
        .then((response) => {
  ...
  deleteRoleList: async (id: string) => {
    ...
    httpRequest('delete', `${envConfig.api_url}/idm/roles/delete`, payload, true, apiToken ,'3ef02e4b-b862-47b0-a48c-939b2e9d16d9')
      .then((response) => {
