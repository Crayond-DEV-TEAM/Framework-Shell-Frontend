...
export const usePermission = create<PermissionInterface>((set, get) => ({
  ...
  getPermissionList: () => {
    ...
    httpRequest('get', `${envConfig.idm_api_url}/permissions`, {}, true)
      .then((response) => {
  ...
  addPermission: (data: any) => {
    ...
    httpRequest('post', `${envConfig.idm_api_url}/permissions/create`, payload, true)
      .then((response) => {
  ...
  editPermission: (data: any) => {
    ...
    set({ fetching: true, errorOnFetching: false });
    httpRequest('put', `${envConfig.idm_api_url}/permissions`, payload, true)
      .then((response) => {
  ...
  updateRopsitory: () => {
    ...
    set({ fetching: true, errorOnFetching: false });
    httpRequest('put', `${envConfig.idm_api_url}/permissions/update`, payload, true)
      .then((response) => {
        enqueueSnackbar('Permission edited Succesfully!', { variant: 'success' });
      })
      .catch((err) => {
