...
export function DocumentationTable(props: DocumentationTableProps): JSX.Element {
  ...
  const ListTable_4 = [
    ...
    createData_4('push_receivers', 'Array', 'List of push notification receivers'),
    createData_4('push_title', 'Array', 'List of data parameters for push title'),
    createData_4('push_body', 'Object', 'List of data parameters for push body'),
    createData_4('push_click_action', 'String', 'URL to open site when clicking a received push notification'),
    createData_4('push_icon', 'String', 'Pass an image URL to set as an icon to the push notification'),
    createData_4('to_mobiles', 'Array', 'List of mobile numbers to send SMS'),
    createData_4('sms_body', 'Array', 'sms_boList of data parameters for sms bodydy'),
  ];
