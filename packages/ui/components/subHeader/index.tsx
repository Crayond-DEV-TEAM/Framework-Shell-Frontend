...
import { SearchTextField } from '@core/ui/components/searchTextField';
                                ...
                                return (
                                    <Box key={index}>
                                        <Typography
                                            sx={
                                                selectbtn === e.label
                                                    ? subHeader_Style.buttontextClick
                                                    : subHeader_Style.buttonText
                                            }
                                            key={i}
