...
export const useRoles = create<RolesInterface>((set, get) => ({
  ...
  getRolesList: () => {
    ...
    httpRequest('post', `${envConfig.api_idm_url}/roles`, payload, true)
      .then((response) => {
  ...
  addRolesList: () => {
    ...
    httpRequest('post', `${envConfig.api_idm_url}/roles/create`, payload, true)
      .then((response) => {
  ...
  getStatusList: (id: any, status: any) => {
    ...
    httpRequest('put', `${envConfig.api_idm_url}/roles/update`, payload, true)
      .then((response) => {
  ...
  deleteRoleList: (id: string) => {
    ...
    httpRequest('delete', `${envConfig.api_idm_url}/roles`, payload, true)
      .then((response) => {
